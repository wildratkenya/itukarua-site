...
const FAQS = [
  ...
  { id: 'payments', label: 'Payments & M-Pesa', answer: 'We use M-Pesa. Go to the Pricing page, click Pay, and follow the instructions. You will receive an STK push prompt on your phone to enter your M-Pesa PIN.' },
