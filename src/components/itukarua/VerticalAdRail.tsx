  ...
  return (
    <div className="relative">
      <div className="flex items-center justify-between px-1 mb-2">
        <span className="text-xs font-bold uppercase tracking-wide text-gray-500">Sponsored Banners</span>
        <span className="px-1.5 py-0.5 bg-amber-500/80 text-white text-[8px] font-bold rounded uppercase">Ad</span>
      </div>
      <div
          ...
          {loop.map((ad, i) => (
            ...
            >
              <div className="relative" style={{ height: 180 }}>
                ...
                <span className="absolute top-1.5 left-1.5 px-1.5 py-0.5 bg-amber-500/80 text-white text-[8px] font-bold rounded uppercase">Ad</span>
                <p className="absolute bottom-1.5 inset-x-1.5 text-white text-xs font-medium leading-tight text-left">{ad.title}</p>
              </div>
            </button>
          ))}
        </div>
